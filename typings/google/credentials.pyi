...
class Credentials(credentials.ReadOnlyScoped, credentials.CredentialsWithQuotaProject):
    ...
    google-auth[reauth]`.
    """
    def __init__(self, token, refresh_token=..., id_token=..., token_uri=..., client_id=..., client_secret=..., scopes=..., default_scopes=..., quota_project_id=..., expiry=..., rapt_token=..., refresh_handler=..., enable_reauth_refresh=..., granted_scopes=...) -> None:
        """
        Args:
    ...
    @property
    def granted_scopes(self): # -> Any | None:
    ...
    @classmethod
    def from_authorized_user_info(cls, info, scopes=...): # -> Self@Credentials:
    ...
    @classmethod
    def from_authorized_user_file(cls, filename, scopes=...): # -> Self@Credentials:
...
class UserAccessTokenCredentials(credentials.CredentialsWithQuotaProject):
    ...
    def with_account(self, account): # -> Self@UserAccessTokenCredentials:
    ...
    @_helpers.copy_docstring(credentials.CredentialsWithQuotaProject)
    def with_quota_project(self, quota_project_id): # -> Self@UserAccessTokenCredentials:
        ...
