...
class Credentials(credentials.Scoped, credentials.CredentialsWithQuotaProject, credentials.CredentialsWithTokenUri):
    ...
    """
    def __init__(self, audience, subject_token_type, token_url, credential_source, service_account_impersonation_url=..., service_account_impersonation_options=..., client_id=..., client_secret=..., token_info_url=..., quota_project_id=..., scopes=..., default_scopes=..., workforce_pool_user_project=...) -> None:
    ...
    @property
    def info(self): # -> dict[str, Unknown | dict[Any, Any]]:
    ...
    @staticmethod
    def validate_token_url(token_url, url_type=...): # -> None:
        ...
    ...
    @staticmethod
    def is_valid_url(patterns, url): # -> bool:
        """
