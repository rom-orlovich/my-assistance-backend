...
def load_credentials_from_file(filename, scopes=..., default_scopes=..., quota_project_id=..., request=...): # -> tuple[Credentials | Unknown | ServiceAccountCredentials, Unknown | Any | None]:
...
def default(scopes=..., request=..., quota_project_id=..., default_scopes=...): # -> tuple[Credentials | Unknown | ServiceAccountCredentials, Unknown | Any | str | None]:
