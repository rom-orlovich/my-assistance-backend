...
class Credentials(credentials.Signing, credentials.Scoped, credentials.CredentialsWithQuotaProject, credentials.CredentialsWithTokenUri):
    ...
    """
    def __init__(self, signer, service_account_email, token_uri, scopes=..., default_scopes=..., subject=..., project_id=..., quota_project_id=..., additional_claims=..., always_use_jwt_access=...) -> None:
        """
        Args:
    ...
    def with_scopes(self, scopes, default_scopes=...): # -> Self@Credentials:
        ...
    ...
    def with_token_uri(self, token_uri): # -> Self@Credentials:
        ...
...
class IDTokenCredentials(credentials.Signing, credentials.CredentialsWithQuotaProject, credentials.CredentialsWithTokenUri):
    ...
    """
    def __init__(self, signer, service_account_email, token_uri, target_audience, additional_claims=..., quota_project_id=...) -> None:
        """
        Args:
            signer (google.auth.crypt.Signer): The signer used to sign JWTs.
            service_account_email (str): The service account's email.
    ...
    @classmethod
    def from_service_account_file(cls, filename, **kwargs): # -> Self@IDTokenCredentials:
        """Creates a credentials instance from a service account json file.
    ...
    @_helpers.copy_docstring(credentials.CredentialsWithQuotaProject)
    def with_quota_project(self, quota_project_id): # -> Self@IDTokenCredentials:
        ...
    
    @_helpers.copy_docstring(credentials.CredentialsWithTokenUri)
    def with_token_uri(self, token_uri): # -> Self@IDTokenCredentials:
        ...
