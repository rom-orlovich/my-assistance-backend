...
class Flow:
    ...
    @classmethod
    def from_client_config(cls, client_config, scopes, **kwargs): # -> Self@Flow:
    ...
    @classmethod
    def from_client_secrets_file(cls, client_secrets_file, scopes, **kwargs): # -> Self@Flow:
    ...
    def authorization_url(self, **kwargs): # -> tuple[Unknown, Unknown]:
...
class InstalledAppFlow(Flow):
    ...
    def run_console(self, authorization_prompt_message=..., authorization_code_message=..., **kwargs): # -> Credentials:
    ...
    def run_local_server(self, host=..., bind_addr=..., port=..., authorization_prompt_message=..., success_message=..., open_browser=..., redirect_uri_trailing_slash=..., timeout_seconds=..., **kwargs): # -> Credentials:
