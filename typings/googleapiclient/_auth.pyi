...
def default_credentials(scopes=..., quota_project_id=...): # -> Credentials | ServiceAccountCredentials:
    """Returns Application Default Credentials."""
    ...

def with_scopes(credentials, scopes): # -> Credentials | <subclass of Credentials and Scoped>:
