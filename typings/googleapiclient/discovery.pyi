...
def createMethod(methodName, methodDesc, rootDesc, schema): # -> tuple[Unknown, (self: Unknown, **kwargs: Unknown) -> Unknown]:
...
def createNextMethod(methodName, pageTokenName=..., nextPageTokenName=..., isPageTokenParameter=...): # -> tuple[Unknown, (self: Unknown, previous_request: Unknown, previous_response: Unknown) -> (Unknown | None)]:
...
class Resource:
    ...
    def __enter__(self): # -> Self@Resource:
        ...
