...
def refresh_grant(request, token_uri, refresh_token, client_id, client_secret, scopes=..., rapt_token=..., enable_reauth_refresh=...): # -> tuple[Any | Unknown, Any | Unknown, datetime | None, Any | Unknown, Any | Unknown | None]:
