...
class Credentials(credentials.CredentialsWithQuotaProject, credentials.ReadOnlyScoped, credentials.CredentialsWithTokenUri):
    ...
    """
    def __init__(self, token=..., expiry=..., refresh_token=..., audience=..., client_id=..., client_secret=..., token_url=..., token_info_url=..., revoke_url=..., scopes=..., quota_project_id=...) -> None:
    ...
    @property
    def info(self): # -> dict[str, Unknown | Any | datetime]:
    ...
    def constructor_args(self): # -> dict[str, Unknown | Any | datetime | None]:
        ...
