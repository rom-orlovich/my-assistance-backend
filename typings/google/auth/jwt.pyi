...
def decode_header(token): # -> Mapping[Unknown, Unknown]:
...
def decode(token, certs=..., verify=..., audience=..., clock_skew_in_seconds=...): # -> Mapping[Unknown, Unknown]:
...
class Credentials(google.auth.credentials.Signing, google.auth.credentials.CredentialsWithQuotaProject):
    ...
    @classmethod
    def from_signing_credentials(cls, credentials, audience, **kwargs): # -> Self@Credentials:
    ...
    def with_claims(self, issuer=..., subject=..., audience=..., additional_claims=...): # -> Self@Credentials:
    ...
    def with_quota_project(self, quota_project_id): # -> Self@Credentials:
        ...
    ...
    @property
    @_helpers.copy_docstring(google.auth.credentials.Signing)
    def signer_email(self): # -> Unknown:
        ...
    
    @property
    @_helpers.copy_docstring(google.auth.credentials.Signing)
    def signer(self): # -> Unknown:
        ...
...
class OnDemandCredentials(google.auth.credentials.Signing, google.auth.credentials.CredentialsWithQuotaProject):
    ...
    @classmethod
    def from_service_account_info(cls, info, **kwargs): # -> Self@OnDemandCredentials:
    ...
    @classmethod
    def from_service_account_file(cls, filename, **kwargs): # -> Self@OnDemandCredentials:
    ...
    @classmethod
    def from_signing_credentials(cls, credentials, **kwargs): # -> Self@OnDemandCredentials:
    ...
    def with_claims(self, issuer=..., subject=..., additional_claims=...): # -> Self@OnDemandCredentials:
        """Returns a copy of these credentials with modified claims.
    ...
    @_helpers.copy_docstring(google.auth.credentials.CredentialsWithQuotaProject)
    def with_quota_project(self, quota_project_id): # -> Self@OnDemandCredentials:
        ...
