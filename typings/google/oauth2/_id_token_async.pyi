...
"""
async def verify_token(id_token, request, audience=..., certs_url=..., clock_skew_in_seconds=...): # -> Mapping[Unknown, Unknown]:
...
async def verify_oauth2_token(id_token, request, audience=..., clock_skew_in_seconds=...): # -> Mapping[Unknown, Unknown]:
...
async def verify_firebase_token(id_token, request, audience=..., clock_skew_in_seconds=...): # -> Mapping[Unknown, Unknown]:
...
async def fetch_id_token(request, audience): # -> Any | str:
