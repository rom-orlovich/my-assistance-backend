...
_LOGGER = ...
_PASSPHRASE_REGEX = ...
def get_client_ssl_credentials(generate_encrypted_key=..., context_aware_metadata_path=...): # -> tuple[Literal[True], Any, Any, Any | None] | tuple[Literal[False], None, None, None]:
...
def get_client_cert_and_key(client_cert_callback=...): # -> tuple[Literal[True], Unknown, Unknown] | tuple[bool, Any | None, Any | None]:
