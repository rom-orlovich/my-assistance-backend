...
class HttpRequest:
    ...
    @util.positional(1)
    def next_chunk(self, http=..., num_retries=...): # -> tuple[MediaUploadProgress | None, Unknown] | tuple[None, Unknown] | tuple[MediaUploadProgress, None]:
    ...
    @staticmethod
    def null_postproc(resp, contents): # -> tuple[Unknown, Unknown]:
        ...
...
class HttpMockSequence:
    ...
    def request(self, uri, method=..., body=..., headers=..., redirections=..., connection_type=...): # -> tuple[Response, bytes | Unknown | None]:
        ...
