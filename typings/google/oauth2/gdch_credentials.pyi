...
class ServiceAccountCredentials(credentials.Credentials):
    ...
    def with_gdch_audience(self, audience): # -> Self@ServiceAccountCredentials:
    ...
    @classmethod
    def from_service_account_info(cls, info): # -> Self@ServiceAccountCredentials:
    ...
    @classmethod
    def from_service_account_file(cls, filename): # -> Self@ServiceAccountCredentials:
