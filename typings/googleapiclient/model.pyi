...
class BaseModel(Model):
    ...
    no_content_response = ...
    alt_param = ...
    def request(self, headers, path_params, query_params, body_value): # -> tuple[Unknown, Unknown, Unknown, Unknown | None]:
        """Updates outgoing requests with a serialized body.
...
class JsonModel(BaseModel):
    ...
    @property
    def no_content_response(self): # -> dict[Unknown, Unknown]:
        ...
...
def makepatch(original, modified): # -> dict[Unknown, Unknown]:
